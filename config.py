...
class Config:
    ...
    active_strategy: str  # stacked_sweep | bb_orb_breakout | vwap_pullback | quad_stoch_div
...
def load_config() -> Config:
    ...
    return Config(
        ...
        active_strategy=str(os.getenv("ACTIVE_STRATEGY", y.get("active_strategy", "quad_stoch_div"))),
        scalp_trail_activate_pct=float(
